	     ...
	     <div class="col-md-4 single-right-left ">
			<div class="grid images_3_of_2">
				<div class="flexslider">
					...
					<img src="<?= base_url(); ?>/vendor/script/images/d2.jpg" data-imagezoom="true" class="img-responsive">

					<!--<ul class="slides">
						<li data-thumb="images/d2.jpg">
							<div class="thumb-image"> <img src="<?/*= base_url(); */?>/vendor/script/images/d2.jpg" data-imagezoom="true" class="img-responsive"> </div>
						</li>
						<li data-thumb="images/d1.jpg">
							<div class="thumb-image"> <img src="<?/*= base_url(); */?>/vendor/script/images/d1.jpg" data-imagezoom="true" class="img-responsive"> </div>
						</li>
						<li data-thumb="images/d3.jpg">
							<div class="thumb-image"> <img src="<?/*= base_url(); */?>/vendor/script/images/d3.jpg" data-imagezoom="true" class="img-responsive"> </div>
						</li>
					</ul>-->
					<div class="clearfix"></div>
				</div>
					  ...
					  <div class="col-md-3 product-men single">
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="<?= base_url(); ?>/vendor/script/images/w2.jpg" alt="" class="pro-image-front">
										<img src="<?= base_url(); ?>/vendor/script/images/w2.jpg" alt="" class="pro-image-back">
                       ...
                       <div class="col-md-3 product-men single">
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="<?= base_url(); ?>/vendor/script/images/w4.jpg" alt="" class="pro-image-front">
										<img src="<?= base_url(); ?>/vendor/script/images/w4.jpg" alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Quick View</a>
												</div>
						 ...
						 <div class="col-md-3 product-men single">
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="<?= base_url(); ?>/vendor/script/images/s6.jpg" alt="" class="pro-image-front">
										<img src="<?= base_url(); ?>/vendor/script/images/s6.jpg" alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Quick View</a>
												</div>
					   ...
					   <div class="col-md-3 product-men single">
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="<?= base_url(); ?>/vendor/script/images/w7.jpg" alt="" class="pro-image-front">
										<img src="<?= base_url(); ?>/vendor/script/images/w7.jpg" alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Quick View</a>
												</div>
...
<script>
	...
	<!-- //cart-js --> 
	<!-- single -->
<script src="<?= base_url(); ?>/vendor/script/js/imagezoom.js"></script>
<!-- single -->
...
<!-- FlexSlider -->
<script src="<?= base_url(); ?>/vendor/script/js/jquery.flexslider.js"></script>
						<script>
