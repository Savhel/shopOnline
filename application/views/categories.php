...
<div class="header" id="home">
	<div class="container">
		<ul>
			<?php
			if (!empty($_SESSION)){
				echo "<li><i class='fa fa-envelope-o' aria-hidden='true'></i> <a href='mailto:info@example.com'>Deconnexion</a></li>
...
<div class="page-head_agile_info_w3l">
		<div class="container">
			<?php
			$getC = "SELECT * FROM categories WHERE IDCATEGORIE = ?";
			$getCategorie = $this->db->query($getC,array($categorieSelect));
			$display = $getCategorie->row();
			?>
			<h3><span><?php if($display == NULL){redirect('welcome');}else{ echo $display->NAMECATEGORIE ;}  ?></span></h3>
			<!--/w3_short-->
	...
	<div class="container">
		...
		<div class="col-md-4 products-left">
			...
			<div class="css-treeview">
				...
				<ul class="tree-list-pad">
					<?php
						$item = 0 ;
						foreach($categorie->result() as $val ){

					?>
							<li><input type="checkbox" checked="<?php if ($val->IDCATEGORIE == $categorieSelect){ echo "checked";}?>" id="item-<?= $item ?>" /><label for="item-0"><i class="fa fa-long-arrow-right" aria-hidden="true"></i><?= $val->NAMECATEGORIE ; ?></label>
								<ul>
									<?php
									$ss = 0;
									$query = "SELECT * FROM souscategorie WHERE IDCATEGORIE =?";
									$getSouscategorie = $this->db->query($query,array($val->IDCATEGORIE));
									foreach($getSouscategorie->result() as $getS ){
									?>
									<li><input type="checkbox" id="item-<?= $item ?>-<?= $ss ?>" /><label for="item-0-0"><i class="fa fa-long-arrow-right" aria-hidden="true"></i><?= $getS->NAMESOUSCATEGORIE ; ?></label>
										<ul>
											<?php
											$check = "SELECT * FROM type WHERE IDSOUSCATEGORIE =?";
											$getType = $this->db->query($query,array($getS->IDSOUSCATEGORIE));
											foreach($getType->result() as $req ){
											?>
											<li><a href="<?= site_url(welcome/categorie) ?>/<?= $val->IDCATEGORIE ?>/<?= $getS->IDSOUSCATEGORIE ?>/<?= $req->IDTYPE ; ?>"><?= $req->NAMETYPE ; ?></a></li>
												<?php
											}
		...
		<div class="col-md-8 products-right">
			...
			<div class="men-wear-top">
				...
				<div  id="top" class="callbacks_container">
					<ul class="rslides" id="slider3">
						<li>
							<img class="img-responsive" src="<?= base_url(); ?>/vendor/script/images/banner2.jpg" alt=" "/>
						</li>
						<li>
							<img class="img-responsive" src="<?= base_url(); ?>/vendor/script/images/banner5.jpg" alt=" "/>
						</li>
						<li>
							<img class="img-responsive" src="<?= base_url(); ?>/vendor/script/images/banner2.jpg" alt=" "/>
						</li>
			...
			<div class="men-wear-bottom">
				<div class="col-sm-4 men-wear-left">
					<img class="img-responsive" src="<?= base_url(); ?>/vendor/script/images/bb2.jpg" alt=" " />
				</div>
				...
				<div class="col-md-4 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="<?= base_url(); ?>/vendor/script/images/m8.jpg" alt="" class="pro-image-front">
										<img src="<?= base_url(); ?>/vendor/script/images/m8.jpg" alt="" class="pro-image-back">
			...
			<div class="col-md-4 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="<?= base_url(); ?>/vendor/script/images/m7.jpg" alt="" class="pro-image-front">
										<img src="<?= base_url(); ?>/vendor/script/images/m7.jpg" alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.php" class="link-product-add-cart">Quick View</a>
												</div>
			...
			<div class="col-md-4 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="<?= base_url(); ?>/vendor/script/images/s1.jpg" alt="" class="pro-image-front">
										<img src="<?= base_url(); ?>/vendor/script/images/s1.jpg" alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.php" class="link-product-add-cart">Quick View</a>
												</div>
		...
		<div class="single-pro">
			<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="<?= base_url(); ?>/vendor/script/images/m1.jpg" alt="" class="pro-image-front">
										<img src="<?= base_url(); ?>/vendor/script/images/m1.jpg" alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.php" class="link-product-add-cart">Quick View</a>
												</div>
							...
							<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="<?= base_url(); ?>/vendor/script/images/m2.jpg" alt="" class="pro-image-front">
										<img src="<?= base_url(); ?>/vendor/script/images/m2.jpg" alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.php" class="link-product-add-cart">Quick View</a>
												</div>
                            ...
                            <div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="<?= base_url(); ?>/vendor/script/images/m3.jpg" alt="" class="pro-image-front">
										<img src="<?= base_url(); ?>/vendor/script/images/m3.jpg" alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.php" class="link-product-add-cart">Quick View</a>
												</div>
							...
							<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="<?= base_url(); ?>/vendor/script/images/m4.jpg" alt="" class="pro-image-front">
										<img src="<?= base_url(); ?>/vendor/script/images/m4.jpg" alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.php" class="link-product-add-cart">Quick View</a>
												</div>
							...
							<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="<?= base_url(); ?>/vendor/script/images/m5.jpg" alt="" class="pro-image-front">
										<img src="<?= base_url(); ?>/vendor/script/images/m5.jpg" alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.php" class="link-product-add-cart">Quick View</a>
												</div>
								...
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="<?= base_url(); ?>/vendor/script/images/m6.jpg" alt="" class="pro-image-front">
										<img src="<?= base_url(); ?>/vendor/script/images/m6.jpg" alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.php" class="link-product-add-cart">Quick View</a>
												</div>
								...
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="<?= base_url(); ?>/vendor/script/images/images/m8.jpg" alt="" class="pro-image-front">
										<img src="<?= base_url(); ?>/vendor/script/images/images/m8.jpg" alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.php" class="link-product-add-cart">Quick View</a>
												</div>
