...
<html>
<head>
	<title>Elite Online Market</title>
<!--/tags -->
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="market Responsive web template, Bootstrap Web Templates, Flat Web Templates, Android Compatible web template,
...
<link href="<?= base_url(); ?>/vendor/script/css/team.css" rel="stylesheet" type="text/css" media="all" />
			  ...
			  <div class="container-fluid">
				...
				<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
				  <ul class="nav navbar-nav menu__list">
					...
					<li class=" menu__item menu__item--current"><a class="menu__link" href="<?= base_url(); ?>">About</a></li>
					<li class="dropdown menu__item">
						<a href="#" class="dropdown-toggle menu__link" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Men's wear <span class="caret"></span></a>
							<ul class="dropdown-menu multi-column columns-3">
								<div class="agile_inner_drop_nav_info">
									<div class="col-sm-6 multi-gd-img1 multi-gd-text ">
										<a href="<?= base_url(); ?>/site"><img src="images/top2.jpg" alt=" "/></a>
									</div>
									<div class="col-sm-3 multi-gd-img">
										<ul class="multi-column-dropdown">
											<li><a href="categories.php">Clothing</a></li>
											<li><a href="categories.php">Wallets</a></li>
											<li><a href="categories.php">Footwear</a></li>
											<li><a href="categories.php">Watches</a></li>
											<li><a href="categories.php">Accessories</a></li>
											<li><a href="categories.php">Bags</a></li>
											<li><a href="categories.php">Caps & Hats</a></li>
										</ul>
									</div>
									<div class="col-sm-3 multi-gd-img">
										<ul class="multi-column-dropdown">
											<li><a href="categories.php">Jewellery</a></li>
											<li><a href="categories.php">Sunglasses</a></li>
											<li><a href="categories.php">Perfumes</a></li>
											<li><a href="categories.php">Beauty</a></li>
											<li><a href="categories.php">Shirts</a></li>
											<li><a href="categories.php">Sunglasses</a></li>
											<li><a href="categories.php">Swimwear</a></li>
										</ul>
									</div>
									<div class="clearfix"></div>
								</div>
			...
			<div class="sign-grds">
				<div class="col-md-4 sign-gd">
					...
					<ul>
						...
						<li><a href="categories.php">Men's Wear</a></li>
